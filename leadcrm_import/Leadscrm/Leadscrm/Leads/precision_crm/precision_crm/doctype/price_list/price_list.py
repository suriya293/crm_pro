...
class PriceList(Document):
    def autoname(self):
        apply_naming_series(self, "PRICE")
    ...
    def validate(self):
        ...
        if not has_permission(self, "write"):
            frappe.throw("You do not have permission to write to this Price List record.")
    ...
    def on_trash(self):
        if not has_permission(self, "delete"):
            frappe.throw("You do not have permission to delete this Price List record.")
