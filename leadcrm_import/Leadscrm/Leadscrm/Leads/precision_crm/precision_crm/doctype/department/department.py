...
class Department(Document):
    ...
    def validate(self):
        ...
        if not has_permission(self, "write"):
            frappe.throw("You do not have permission to write to this Department record.")
    ...
    def on_trash(self):
        if not has_permission(self, "delete"):
            frappe.throw("You do not have permission to delete this Department record.")
