...
class WhatsAppConversation(Document):
    def autoname(self):
        apply_naming_series(self, "WACONV")
    ...
    def validate(self):
        ...
        if not has_permission(self, "write"):
            frappe.throw("You do not have permission to write to this WhatsApp Conversation record.")
    ...
    def on_trash(self):
        if not has_permission(self, "delete"):
            frappe.throw("You do not have permission to delete this WhatsApp Conversation record.")
