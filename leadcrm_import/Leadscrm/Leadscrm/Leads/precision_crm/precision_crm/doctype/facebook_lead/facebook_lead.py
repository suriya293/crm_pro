...
class FacebookLead(Document):
    def autoname(self):
        apply_naming_series(self, "FBLEAD")
    ...
    def validate(self):
        ...
        if not has_permission(self, "write"):
            frappe.throw("You do not have permission to write to this Facebook Lead record.")
    ...
    def on_trash(self):
        if not has_permission(self, "delete"):
            frappe.throw("You do not have permission to delete this Facebook Lead record.")
