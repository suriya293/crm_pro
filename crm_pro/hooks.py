...
doc_events = {
    ...
    "User": {
        "validate": "crm_pro.crm_pro.utils.mobile_validator.validate_user_mobile",
        "on_trash": "crm_pro.crm_pro.api.user_on_trash"
    },
    "CRM User Profile": {
        "validate": "crm_pro.crm_pro.utils.mobile_validator.validate_profile_mobile"
    }
}
